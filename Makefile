...
config:
	...
	@echo ""
	@echo "Web UI JavaScript:"
	@echo "  JQUERY_JS               = $(JQUERY_JS)"
	@echo "  MUSTACHE_JS             = $(MUSTACHE_JS)"
	@echo "  CBUFFER_JS              = $(CBUFFER_JS)"
	@echo "  BOOTSTRAP_JS            = $(BOOTSTRAP_JS)"
	@echo "  D3_JS                   = $(D3_JS)"
	@echo "  PAKO_JS                 = $(PAKO_JS)"
	@echo ""
	@echo "Performance:"
